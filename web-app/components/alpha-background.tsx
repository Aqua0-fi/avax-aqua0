...
// Ambient Aqua0 pointillism background — soft ocean caustics drawn on a
// canvas behind every page. Ported verbatim from aqua0/web-app so the two
// surfaces feel like the same product. Fixed to the viewport (z-0,
// pointer-events: none) and renders at ~45% opacity to keep type legible.
//
// Math: a value-noise field is sampled on a step grid, ridged into caustic
// curves, then masked toward the edges so the center stays clean for
// content. The animation just pans the noise origin over time.
