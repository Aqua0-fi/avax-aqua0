...
// Root — the surface a hackathon judge / a new visitor hits first.
//
// Mirrors the production aqua0/web-app hero pattern (tight-tracked
// display heading + a dotted-underline emphasis in the subtitle + a 3-step
// explainer card below) so the Avalanche edition reads as the same product,
// just narrowed to the LATAM stablecoin pitch.
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-12 pb-16 sm:px-6 lg:px-8">
        ...
        {/* ── "Open the demo" CTA card (corner cyan glow) ────────────────── */}
        <DemoCTA />
...
/* ────────────────────────────────────────────────────────────────────────────
   ...
   entrypoints (faucet drip + profile). Mirrors the BuildYourOwnCTA shape
   from the production landing.
   ─────────────────────────────────────────────────────────────────────────── */
...
/* ────────────────────────────────────────────────────────────────────────────
   ...
   in cyan. Mirrors the production PoolsExplainer composition.
   ─────────────────────────────────────────────────────────────────────────── */
...
/* Pixel-art illustrations — chunky retro SVGs that match the brand language.
   Identical structure to the production explainer, retitled mentally for
   our 7 tokens / 6 pools scope. */
...
/* ────────────────────────────────────────────────────────────────────────────
   Quick stats strip — sits below the explainer to ground the pitch in
   concrete numbers without overloading the hero. The `highlighted` value is
   the multiplier — the punchline of the whole project.
   ─────────────────────────────────────────────────────────────────────────── */
